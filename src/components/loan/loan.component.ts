...
propertySubcategories: Record<string, SubcategoryItem[]> = {
  ...
  residential: [
    ...
    { value: 'residential:manufatured_home', name: 'Manufatured Home'},
    { value: 'residential:mobile_home_double_wide', name: 'Mobile Home Double Wide'},
    { value: 'residential:mobile_home_single_wide', name: 'Mobile Home Single Wide'},
    { value: 'residential:modular_home', name: 'Modular Home'},
