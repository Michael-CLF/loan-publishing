...
propertySubcategories: Record<string, SubcategoryItem[]> = {
  ...
  residential: [
    ...
    { value: 'residentail:manufatured_home', name: 'Manufatured Home'},
    { value: 'residentail:mobile_home_double_wide', name: 'Mobile Home Double Wide'},
    { value: 'residentail:mobile_home_single_wide', name: 'Mobile Home Single Wide'},
    { value: 'residentail:modular_home', name: 'Modular Home'},
